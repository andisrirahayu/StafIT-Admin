<!-- log-berdasarkan-tanggal.blade.php -->
...
<head>
    ...
    <title>Log Berdasarkan Tanggal</title>
...
<body>
    ...
    <div class="header">
        ...
        <h1 class="title">Log Berdasarkan Tanggal</h1>
    </div>

    <!-- Menampilkan Daftar Laporan Kejadian Berdasarkan Tanggal -->
    <div class="log-cards">
